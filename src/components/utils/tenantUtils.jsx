...
export const DEFAULT_NH_SELLER_TEMPLATE = {
  name: "NH Standard (Seller)",
  transaction_type: "seller",
  state: "NH",
  is_default: false,
  phases: [
    { phase_number: 1, phase_name: "Pre-Contract" },
    { phase_number: 2, phase_name: "Listing Active" },
    { phase_number: 3, phase_name: "Offer Accepted" },
    { phase_number: 4, phase_name: "Escrow Opened" },
    { phase_number: 5, phase_name: "Inspection Period" },
    { phase_number: 6, phase_name: "Repair Negotiations" },
    { phase_number: 7, phase_name: "Appraisal Ordered" },
    { phase_number: 8, phase_name: "Buyer Financing" },
    { phase_number: 9, phase_name: "Clear to Close" },
    { phase_number: 10, phase_name: "Final Walkthrough" },
    { phase_number: 11, phase_name: "Closing" },
    { phase_number: 12, phase_name: "Post Closing" },
  ...
  tasks: [
    { id: "st1", phase_number: 3, task_name: "Send contract to title company", default_assignee_role: "tc", due_offset_days: 1, due_anchor: "contract_date", required: true },
    { id: "st2", phase_number: 3, task_name: "Notify seller of accepted offer", default_assignee_role: "agent", due_offset_days: 0, due_anchor: "contract_date", required: true },
    { id: "st3", phase_number: 3, task_name: "Send seller disclosure packets", default_assignee_role: "tc", due_offset_days: 1, due_anchor: "contract_date", required: true },
    { id: "st4", phase_number: 4, task_name: "Collect earnest money from buyer", default_assignee_role: "tc", due_offset_days: 1, due_anchor: "contract_date", required: true },
    { id: "st5", phase_number: 5, task_name: "Prepare property for inspection", default_assignee_role: "agent", due_offset_days: 3, due_anchor: "contract_date", required: true },
    { id: "st6", phase_number: 6, task_name: "Negotiate repair requests", default_assignee_role: "agent", due_offset_days: 15, due_anchor: "contract_date", required: false },
    { id: "st7", phase_number: 8, task_name: "Monitor buyer financing status", default_assignee_role: "tc", due_offset_days: 20, due_anchor: "contract_date", required: true },
    { id: "st8", phase_number: 9, task_name: "Schedule closing", default_assignee_role: "agent", due_offset_days: 25, due_anchor: "contract_date", required: true },
    { id: "st9", phase_number: 11, task_name: "Confirm wire instructions received", default_assignee_role: "tc", due_offset_days: -2, due_anchor: "closing_date", required: true },
    { id: "st10", phase_number: 11, task_name: "Provide keys and access info", default_assignee_role: "agent", due_offset_days: 0, due_anchor: "closing_date", required: true },
    { id: "st11", phase_number: 12, task_name: "Archive closing documents", default_assignee_role: "tc", due_offset_days: 2, due_anchor: "closing_date", required: true },
  ],
  deadlines: [
    { id: "sd1", deadline_type: "inspection", due_offset_days: 10, due_anchor: "contract_date" },
    { id: "sd2", deadline_type: "appraisal", due_offset_days: 14, due_anchor: "contract_date" },
    { id: "sd3", deadline_type: "financing", due_offset_days: 21, due_anchor: "contract_date" },
