      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-1 p-1 rounded-lg border" style={{ background: "var(--bg-tertiary)", borderColor: "var(--card-border)" }}>
          <Button
            ...
            className={`h-8 px-3 gap-1.5 text-xs font-medium transition-all ${viewMode === "cards" ? "bg-white shadow-sm text-blue-600" : "text-gray-500 hover:text-gray-700"}`}
          ...
          <Button
            ...
            className={`h-8 px-3 gap-1.5 text-xs font-medium transition-all ${viewMode === "list" ? "bg-white shadow-sm text-blue-600" : "text-gray-500 hover:text-gray-700"}`}
