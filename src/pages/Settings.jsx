              ...
              <Card className="shadow-sm border-gray-100">
                ...
                <CardContent className="space-y-3">
                  {(() => {
                    ...
                    const seatUsers = allUsers.filter(u => u.brokerage_id === currentUser?.brokerage_id && ["tc", "agent"].includes(u.role) && u.status !== "disabled");
                    ...
                    return (
                      <div className="grid gap-3">
                        {planOrder.map((p) => {
                          ...
                          return (
                            <div key={p} className={`flex items-center justify-between p-4 rounded-xl border ${isCurrent ? "border-blue-300 bg-blue-50/50" : "border-gray-100 bg-white"}`}>
                              ...
                              <div className="flex items-center gap-3">
                                ...
                                {!isCurrent && (
                                  <Button size="sm" variant={isUpgrade ? "default" : "outline"} className={isUpgrade ? "bg-blue-600 hover:bg-blue-700" : ""}
                        ...
                        <p className="text-xs text-gray-400 mt-2">Stripe billing requires the Builder+ plan. Contact support to enable payment processing.</p>
                      </div>
                    );
                  })()}
                </CardContent>
